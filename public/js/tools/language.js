...
$(document).ready(function() {
    ...
    if (language == "en") {
        ...
        document.title = 'Color plate - Sandwich panels - Color steel sandwich - Steel tile - A fireproof board - Shenzhen Puyuan New Materials Co. Ltd';
    }
    else {
        $(".en").hide();
        $(".cn").show();
        $(".cn-select").addClass("selected");
        document.title = '彩钢板-彩钢夹心板-夹心彩钢板-彩钢瓦-防火A级板房-深圳市普源新型材料有限公司';
    }
});